    ...
    <>
      ...
      <main className="bg-white pt-16 md:pt-[72px]">
        ...
        >
          ...
          <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(2,6,23,0.92)_0%,rgba(2,6,23,0.78)_48%,rgba(2,6,23,0.56)_72%,rgba(2,6,23,0.8)_100%)]"></div>
          ...
          <div className="container relative z-10 w-full py-section md:py-section-lg">
            <motion.div
              ...
              className="grid items-start gap-8 md:gap-10 lg:grid-cols-[minmax(0,1.15fr)_220px]"
            >
              <div className="max-w-3xl">
                ...
                >
                  La comunidad que impulsa el turismo en Córdoba
                </motion.h1>
                ...
                >
                  Representamos, capacitamos y fortalecemos a las agencias de viajes de la provincia.
                </motion.p>
              ...
              <motion.div variants={fadeUp} className="justify-center md:flex md:justify-start lg:justify-end">
                <div className="mx-auto w-full max-w-[300px] md:mx-0 md:max-w-[240px]">
                  <div className="grid grid-cols-4 gap-2 md:grid-cols-2 md:gap-2.5 lg:grid-cols-1 lg:gap-2.5">
                    {[
                      { poster: '/images/thumbs/evento-1.jpg', title: 'Workshop', video: true },
                      { poster: '/images/thumbs/destino-1.jpg', title: 'Destinos', video: false },
                      { poster: '/images/thumbs/capacitacion-1.jpg', title: 'Capacitaciones', video: true },
                      { poster: '/images/thumbs/agencias-1.jpg', title: 'Agencias', video: true },
                    ].map((t, i) => (
                      <div
                        key={i}
                        className="group relative h-[74px] w-full overflow-hidden rounded-[12px] border border-white/15 bg-slate-900/40 shadow-[0_10px_24px_rgba(2,6,23,0.35)] sm:h-[86px] md:h-[106px] md:rounded-[14px] lg:h-[96px]"
                      >
                        <div
                        ...
                        {t.video ? (
                          <div className="absolute right-2 top-2 md:right-2.5 md:top-2.5">
                            <span className="flex size-6 items-center justify-center rounded-full bg-white text-slate-900 shadow-md md:size-7">
                  ...
                  <div className="mt-3 hidden lg:flex justify-center">
                    <motion.span
                      ...
                      className="inline-flex size-8 items-center justify-center rounded-full border border-white/15 bg-white/5 text-white/80 backdrop-blur-sm"
                    >
                      <FiChevronRight className="rotate-90 text-[14px]" />
                    </motion.span>
                  </div>
                </div>
              </motion.div>
              ...
              {[
                {
                  ...
                  mock: '/images/projects/empleabilidad-mockup.png',
                ...
                },
                {
                  ...
                  mock: '/images/projects/cursos-mockup.png',
                  alt: 'Cursos ACAV',
                },
              ].map((p) => (
                <article
                ...
                {[
                  ...
                  <SwiperSlide key={p.title}>
                    ...
                    >
                      ...
                      <Link
                        href="#"
                        className="mt-5 inline-flex h-10 w-full items-center justify-center gap-2 rounded-full bg-white/10 px-5 text-[11px] font-bold uppercase text-white ring-1 ring-inset ring-white/15"
                      >
                        {p.cta}
                        <FiArrowRight className="text-[12px]" />
                      </Link>
        ...
        <section id="comision" className="pb-section md:pb-section-lg">
          ...
          >
            ...
            <div className="relative mt-7 md:mt-8">
              ...
              >
                {(
                  siteConfig.sections.board.members as unknown as {
                    name: string
                    role: string
                    company: string
                    photo: string
                  ...
                  <SwiperSlide key={`${member.role}-${member.name}-${idx}`}>
                    <article className="rounded-[22px] border border-slate-200 bg-white px-3 pb-4 pt-3 text-center shadow-[0_14px_35px_rgba(15,23,42,0.06)] transition duration-300 hover:-translate-y-0.5">
                      ...
                      <p className="mt-4 text-[10.5px] font-bold uppercase text-primary-600">{member.role}</p>
                      <p className="mt-2 text-sm font-bold leading-5 text-slate-900">{member.name}</p>
                      <p className="mt-1.5 text-[11px] leading-5 text-slate-500">{member.company}</p>
                    </article>
                  </SwiperSlide>
                ))}
              </Swiper>
        ...
        <footer className="bg-[#04112e] pt-section text-white">
          ...
          >
            <motion.div
              variants={staggerWrap}
              className="grid gap-8 pb-section sm:gap-10 sm:grid-cols-2 lg:grid-cols-4 lg:gap-8"
            >
              <motion.div variants={fadeUp}>
                <Image
                  src="/images/logo.png"
              ...
              <motion.div variants={fadeUp}>
                ...
                <div className="mt-5 flex flex-col gap-2.5 text-sm text-white/70">
                  ...
                  <Link href="#eventos" className="transition hover:text-white">Eventos</Link>
                  ...
                  <Link href="#institucional" className="transition hover:text-white">Institucional</Link>
                </div>
              </motion.div>

              <motion.div variants={fadeUp}>
                <p className="text-[11px] font-bold uppercase text-white/80">Secciones</p>
                <div className="mt-5 flex flex-col gap-2.5 text-sm text-white/70">
                  <Link href="#historia" className="transition hover:text-white">Nuestra Historia</Link>
                  <Link href="#comision" className="transition hover:text-white">Comisión Directiva</Link>
                  <Link href="#asociate" className="transition hover:text-white">Asociarse</Link>
                  <Link href="#estatuto" className="transition hover:text-white">Estatuto</Link>
                </div>
              </motion.div>
            ...
            >
              <p>
                © {new Date().getFullYear()} ACAV — Asociación Cordobesa de Agencias de Viajes. Todos los derechos reservados.
              </p>
